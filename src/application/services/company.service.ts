...
import { ICompanyEntity } from "../../infra/entities";
import { ICompanyMapper } from "../../infra/mappers";
import { ICompanyFilter, ICompanyRepository } from "../../infra/repositories";
import { ICompanyApplicationService } from "./interfaces";

@Injectable()
export class CompanyService implements ICompanyApplicationService {
  constructor(
