...
import { IEmployeeMapper } from "../../infra/mappers";
import { IEmployeeFilter, IEmployeeRepository } from "../../infra/repositories";
import { IEmployeeApplicationService } from "./interfaces";

@Injectable()
export class EmployeeService implements IEmployeeApplicationService {
  constructor(
